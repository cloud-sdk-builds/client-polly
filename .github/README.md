...
[`@aws-sdk/client-polly`](https://www.npmjs.com/package/@aws-sdk/client-polly/v/3.1121.0).
...
- @aws-sdk/client-polly v3.1121.0 - [https://cloud-sdk-builds.github.io/?sdk=client-polly&version=3.1121.0](https://cloud-sdk-builds.github.io/?sdk=client-polly&version=3.1121.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-polly@3.1121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V+kNteeFf+kNGWZvJyi0JmLBKTb+DieqZo7+Odet9HA7Y/KCPYT+UtkfCtEPVgj2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-polly": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-polly@3.1121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-polly@3.1121.0/index.min.mjs": "sha384-V+kNteeFf+kNGWZvJyi0JmLBKTb+DieqZo7+Odet9HA7Y/KCPYT+UtkfCtEPVgj2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-polly/blob/refs/tags/3.1121.0/LICENSE
```
